...
Скриншоты и отчеты находятся в директории:
- [security-reports/](security-reports/)

Они включают проверки и результаты по заголовкам безопасности, защите от XSS и корректности настройки JWT/HTTPS (смотрите конкретные файлы внутри папки).